...
`from smallestai.speech import WavesStreamingTTS, TTSConfig` regressed
...
def test_legacy_waves_imports_work() -> None:
    from smallestai.speech import TTSConfig, WavesStreamingTTS
...
def test_tts_config_accepts_pronunciation_dicts() -> None:
    from smallestai.speech import TTSConfig
...
def test_streaming_url_is_current_tts_live() -> None:
    ...
    from smallestai.speech import WavesStreamingTTS
