...
def test_atoms_agentVersioningDrafts_get_draft_detail() -> None:
    ...
    verify_request_count(test_id, "GET", "/agent/id/drafts/draftId", None, 1)
...
def test_atoms_agentVersioningDrafts_discard_draft() -> None:
    ...
    verify_request_count(test_id, "DELETE", "/agent/id/drafts/draftId", None, 1)
...
def test_atoms_agentVersioningDrafts_rename_draft() -> None:
    ...
    verify_request_count(test_id, "PATCH", "/agent/id/drafts/draftId", None, 1)
...
def test_atoms_agentVersioningDrafts_get_draft_diff() -> None:
    ...
    verify_request_count(test_id, "GET", "/agent/id/drafts/draftId/diff", None, 1)
...
def test_atoms_agentVersioningDrafts_publish_draft() -> None:
    ...
    verify_request_count(test_id, "POST", "/agent/id/drafts/draftId/publish", None, 1)
...
def test_atoms_agentVersioningDrafts_test_call_with_draft_config() -> None:
    ...
    verify_request_count(test_id, "POST", "/agent/id/drafts/draftId/test-call", None, 1)
...
def test_atoms_agentVersioningDrafts_update_draft_config() -> None:
    ...
    verify_request_count(test_id, "PATCH", "/agent/id/drafts/draftId/config", None, 1)
