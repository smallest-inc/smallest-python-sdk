...
def test_atoms_agentVersioningBranches_list_() -> None:
    ...
    client.agents.agent_versioning_branches.list(
        id="id",
    )
...
def test_atoms_agentVersioningBranches_create_branch() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.create_branch(
        id="id",
...
def test_atoms_agentVersioningBranches_get() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.get(
        id="id",
        branch_id="branchId",
    )
...
def test_atoms_agentVersioningBranches_rename() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.rename(
        id="id",
        branch_id="branchId",
        name="name",
    )
...
def test_atoms_agentVersioningBranches_archive() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.archive(
        id="id",
        branch_id="branchId",
    )
...
def test_atoms_agentVersioningBranches_make_live() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.make_live(
        id="id",
        branch_id="branchId",
    )
...
def test_atoms_agentVersioningBranches_get_draft() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.get_draft(
        id="id",
        branch_id="branchId",
    )
...
def test_atoms_agentVersioningBranches_update_draft() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.update_draft(
        id="id",
        branch_id="branchId",
    )
...
def test_atoms_agentVersioningBranches_discard_draft() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.discard_draft(
        id="id",
        branch_id="branchId",
    )
...
def test_atoms_agentVersioningBranches_publish_draft() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.publish_draft(
        id="id",
        branch_id="branchId",
    )
...
def test_atoms_agentVersioningBranches_cancel_publish() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.cancel_publish(
        id="id",
        branch_id="branchId",
    )
...
def test_atoms_agentVersioningBranches_test_call() -> None:
    ...
    client = get_client(test_id)
    client.agents.agent_versioning_branches.test_call(
        id="id",
        branch_id="branchId",
    )
