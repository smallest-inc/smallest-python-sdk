...
def test_atoms_agents_list_agents() -> None:
    ...
    client.agents.agents.list_agents()
...
def test_atoms_agents_create_agent() -> None:
    ...
    client = get_client(test_id)
    client.agents.agents.create_agent(
        name="name",
    )
...
def test_atoms_agents_duplicate_agent() -> None:
    ...
    client = get_client(test_id)
    client.agents.agents.duplicate_agent(
        id="id",
...
def test_atoms_agents_get_agent() -> None:
    ...
    client = get_client(test_id)
    client.agents.agents.get_agent(
        id="id",
    )
...
def test_atoms_agents_update_agent() -> None:
    ...
    client = get_client(test_id)
    client.agents.agents.update_agent(
        id="id",
    )
...
def test_atoms_agents_get_agent_widget_config() -> None:
    ...
    client = get_client(test_id)
    client.agents.agents.get_agent_widget_config(
        id="id",
    )
...
def test_atoms_agents_update_agent_widget_config() -> None:
    ...
    client = get_client(test_id)
    client.agents.agents.update_agent_widget_config(
        id="id",
    )
...
def test_atoms_agents_get_agent_avatar_presigned_url() -> None:
    ...
    client = get_client(test_id)
    client.agents.agents.get_agent_avatar_presigned_url(
        id="id",
        file_name="fileName",
...
def test_atoms_agents_get_agent_call_logs() -> None:
    ...
    client = get_client(test_id)
    client.agents.agents.get_agent_call_logs(
        id="id",
    )
...
def test_atoms_agents_archive_agent() -> None:
    ...
    client = get_client(test_id)
    client.agents.agents.archive_agent(
        id="id",
    )
