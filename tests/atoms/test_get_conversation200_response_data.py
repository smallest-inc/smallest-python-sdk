...
class TestGetConversation200ResponseData(unittest.TestCase):
    """GetConversation200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetConversation200ResponseData:
        """Test GetConversation200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetConversation200ResponseData`
        """
        model = GetConversation200ResponseData()
        if include_optional:
            return GetConversation200ResponseData(
                id = 'abc123',
                call_id = 'abc123',
    ...
    def testGetConversation200ResponseData(self):
        """Test GetConversation200ResponseData"""
