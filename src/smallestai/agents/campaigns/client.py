...
class AsyncCampaignsClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.campaigns.list()
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.campaigns.create(
                name="My Campaign",
                audience_id="60d0fe4f5311236168a109ca",
                agent_id="60d0fe4f5311236168a109ca",
            )
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> GetCampaignsResponse:
        ...
        async def main() -> None:
            await client.agents.campaigns.get(
                id="id",
            )
    ...
    async def delete(
        ...
        async def main() -> None:
            await client.agents.campaigns.delete(
                id="id",
            )
    ...
    async def start_or_resume(
        ...
        async def main() -> None:
            await client.agents.campaigns.start_or_resume(
                id="id",
            )
