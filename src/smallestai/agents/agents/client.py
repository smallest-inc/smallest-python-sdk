...
class AsyncAgentsClient:
    ...
    async def list_agents(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.agents.list_agents()
    ...
    async def create_agent(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.agents.create_agent(
                name="name",
            )
    ...
    async def duplicate_agent(
        ...
        **400 is returned when:**
        ...
        async def main() -> None:
            await client.agents.agents.duplicate_agent(
                id="id",
                target_organization_id="60d0fe4f5311236168a109ca",
            )
    ...
    async def get_agent(
        ...
        **400 — also used for "not found":** if the agent ID does not exist in the
        ...
        async def main() -> None:
            await client.agents.agents.get_agent(
                id="id",
            )
    ...
    async def update_agent(
        ...
        **403** is returned when selecting a gated model (`gpt-5.2`, `electron-kogta`, `electron-kogta-v2`)
        ...
        async def main() -> None:
            await client.agents.agents.update_agent(
                id="id",
            )
    ...
    async def get_agent_widget_config(
        ...
        async def main() -> None:
            await client.agents.agents.get_agent_widget_config(
                id="id",
            )
    ...
    async def update_agent_widget_config(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.agents.update_agent_widget_config(
                id="id",
            )
    ...
    async def get_agent_avatar_presigned_url(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.agents.get_agent_avatar_presigned_url(
                id="id",
                file_name="fileName",
                content_type="contentType",
                file_size=1.1,
    ...
    async def get_agent_call_logs(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.agents.get_agent_call_logs(
                id="id",
            )
    ...
    async def archive_agent(
        ...
        **409 is returned when:**
        ...
        async def main() -> None:
            await client.agents.agents.archive_agent(
                id="id",
            )
