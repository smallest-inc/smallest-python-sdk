...
class AsyncAgentVersioningBranchesClient:
    ...
    async def list(
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.list(
                id="id",
            )
    ...
    async def create_branch(
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.create_branch(
                id="id",
                source_branch_id="sourceBranchId",
                name="name",
            )
    ...
    async def get(
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.get(
                id="id",
                branch_id="branchId",
            )
    ...
    async def rename(
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.rename(
                id="id",
                branch_id="branchId",
                name="name",
            )
    ...
    async def archive(
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.archive(
                id="id",
                branch_id="branchId",
            )
    ...
    async def make_live(
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.make_live(
                id="id",
                branch_id="branchId",
            )
    ...
    async def get_draft(
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.get_draft(
                id="id",
                branch_id="branchId",
            )
    ...
    async def update_draft(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.update_draft(
                id="id",
                branch_id="branchId",
            )
    ...
    async def discard_draft(
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.discard_draft(
                id="id",
                branch_id="branchId",
            )
    ...
    async def publish_draft(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.publish_draft(
                id="id",
                branch_id="branchId",
            )
    ...
    async def cancel_publish(
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.cancel_publish(
                id="id",
                branch_id="branchId",
            )
    ...
    async def test_call(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.agent_versioning_branches.test_call(
                id="id",
                branch_id="branchId",
            )
