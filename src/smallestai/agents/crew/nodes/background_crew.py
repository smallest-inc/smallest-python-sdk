"""
BackgroundCrewNode - Base class for agents that do internal processing.
...
from smallestai.agents.crew.events import SDKEvent
from smallestai.agents.crew.nodes.base import CrewNode


class BackgroundCrewNode(CrewNode):
    """
