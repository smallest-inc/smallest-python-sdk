...
class AsyncComplianceClient:
    ...
    async def get_compliance_status(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.compliance.get_compliance_status(
                country_iso="IN",
                number_type="local",
                user_type="individual",
            )
    ...
    async def get_compliance_requirements(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.compliance.get_compliance_requirements(
                country_iso="IN",
                number_type="local",
                user_type="individual",
            )
    ...
    async def submit(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.compliance.submit(
                country_iso="countryIso",
                number_type="local",
                user_type="individual",
                end_user="endUser",
    ...
    async def resubmit(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.compliance.resubmit(
                id="id",
                documents="documents",
            )
    ...
    async def refresh_compliance_application_status(
        ...
        async def main() -> None:
            await client.agents.compliance.refresh_compliance_application_status(
                id="id",
            )
