...
class AsyncPhoneNumbersClient:
    ...
    async def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> ListPhoneNumbersResponse:
        ...
        **Note:** Imported SIP numbers added via `POST /product/import-phone-number` are **not** included
        ...
        async def main() -> None:
            await client.agents.phone_numbers.list()
    ...
    async def list_all_phone_numbers_platform_sip(
        ...
        async def main() -> None:
            await client.agents.phone_numbers.list_all_phone_numbers_platform_sip()
    ...
    async def search_rentable(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.phone_numbers.search_rentable(
                country_code="US",
                provider="plivo",
            )
    ...
    async def rent(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.phone_numbers.rent(
                phone_number="13183747513",
                provider="plivo",
            )
    ...
    async def release(
        ...
        async def main() -> None:
            await client.agents.phone_numbers.release(
                product_id="6969109c84c74bed175f02a7",
            )
    ...
    async def get_stripe_customer_portal_url(
        ...
        async def main() -> None:
            await client.agents.phone_numbers.get_stripe_customer_portal_url()
    ...
    async def import_sip(
        ...
        *,
        ...
        async def main() -> None:
            await client.agents.phone_numbers.import_sip(
                phone_number="+14155551234",
                sip_termination_url="trunk.your-provider.com",
                name="Main Support Line",
                sip_username="",
