...
`from smallestai.speech import WavesStreamingTTS, TTSConfig` pattern
...
For new code, prefer the namespaced Fern client:
    ...
    client.speech.lightning_v31tts.connect(...)
...
class WavesStreamingTTS:
    ...
    Example::
        ...
        from smallestai.speech import WavesStreamingTTS, TTSConfig
