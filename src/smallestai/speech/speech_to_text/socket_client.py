...
class AsyncSpeechToTextSocketClient(EventEmitterMixin):
    ...
    async def send_audio_chunk_out(self, message: bytes) -> None:
        """
    ...
    async def send_finalize_signal(self, message: FinalizeSignal) -> None:
        """
        Send a message to the websocket connection.
        The message will be sent as a FinalizeSignal.
        """
        await self._send_model(message)

    async def send_close_stream(self, message: CloseStream) -> None:
        """
        Send a message to the websocket connection.
...
class SpeechToTextSocketClient(EventEmitterMixin):
    ...
    def send_audio_chunk_out(self, message: bytes) -> None:
        """
        Send a message to the websocket connection.
        The message will be sent as a bytes.
        """
    ...
    def send_finalize_signal(self, message: FinalizeSignal) -> None:
        """
        Send a message to the websocket connection.
        The message will be sent as a FinalizeSignal.
        """
    ...
    def send_close_stream(self, message: CloseStream) -> None:
        """
        Send a message to the websocket connection.
        The message will be sent as a CloseStream.
        """
