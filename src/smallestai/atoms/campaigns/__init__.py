...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "ExportCampaignResultsByAudienceMemberRequestFormat": ".types",
    "ExportCampaignResultsByAudienceMemberResponse": ".types",
    "ExportCampaignResultsByAudienceMemberResponseDataItem": ".types",
