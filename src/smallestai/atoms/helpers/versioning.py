...
class MigrationRequiredError(VersioningError):
    ...
    Migrate to the branch/revision API (client.atoms.agent_versioning_branches).
    """
...
class Versioning:
    ...
    def __init__(self, client: typing.Any):
        self._client = client
        self.branches = client.atoms.agent_versioning_branches
        self.revisions = client.atoms.agent_versioning_revisions
