...
class AgentDtoPreCallApi(UncheckedBaseModel):
    """
    ...
    method: AgentDtoPreCallApiMethod = pydantic.Field()
    """
    ...
    response_variables: typing_extensions.Annotated[
        typing.Optional[typing.List[AgentDtoPreCallApiResponseVariablesItem]],
