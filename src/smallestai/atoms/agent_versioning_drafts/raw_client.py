...
class RawAgentVersioningDraftsClient:
    ...
    def list_active_drafts(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"agent/{encode_path_param(id)}/drafts",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=GetAgentIdDraftsResponse,  # type: ignore
    ...
    def get_draft_detail(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"agent/{encode_path_param(id)}/drafts/{encode_path_param(draft_id)}",
            base_url=self._client_wrapper.get_environment().atoms,
            method="GET",
            params={
                "limit": limit,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=GetAgentIdDraftsDraftIdResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_draft_diff(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"agent/{encode_path_param(id)}/drafts/{encode_path_param(draft_id)}/diff",
            base_url=self._client_wrapper.get_environment().atoms,
            method="GET",
            params={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=GetAgentIdDraftsDraftIdDiffResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def publish_draft(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"agent/{encode_path_param(id)}/drafts/{encode_path_param(draft_id)}/publish",
            base_url=self._client_wrapper.get_environment().atoms,
            method="POST",
            json={
                "label": label,
    ...
    def test_call_with_draft_config(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"agent/{encode_path_param(id)}/drafts/{encode_path_param(draft_id)}/test-call",
            base_url=self._client_wrapper.get_environment().atoms,
            method="POST",
            json={
                "mode": mode,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=PostAgentIdDraftsDraftIdTestCallResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def update_draft_config(
        ...
        **post-call analytics (disposition metrics)**, and more. There is no
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"agent/{encode_path_param(id)}/drafts/{encode_path_param(draft_id)}/config",
            base_url=self._client_wrapper.get_environment().atoms,
            method="PATCH",
            json={
                ...
                "postCallAnalyticsConfig": convert_and_respect_annotation_metadata(
                    object_=post_call_analytics_config, annotation=PostCallAnalyticsConfig, direction="write"
                ),
                "language": language,
                "synthesizer": synthesizer,
                "slmModel": slm_model,
                "transcriberType": transcriber_type,
                "customLLMWebSocketUrl": custom_llm_web_socket_url,
...
class AsyncRawAgentVersioningDraftsClient:
