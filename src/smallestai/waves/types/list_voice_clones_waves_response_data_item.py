...
class ListVoiceClonesWavesResponseDataItem(UncheckedBaseModel):
    ...
    status: typing.Optional[ListVoiceClonesWavesResponseDataItemStatus] = None
    cloning_type: typing_extensions.Annotated[
        typing.Optional[ListVoiceClonesWavesResponseDataItemCloningType],
