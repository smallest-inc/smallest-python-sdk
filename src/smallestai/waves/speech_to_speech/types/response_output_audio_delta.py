...
class ResponseOutputAudioDelta(UncheckedBaseModel):
    type: typing.Optional[ResponseOutputAudioDeltaType] = None
    ...
    """
    Base64-encoded PCM16 audio chunk at the negotiated output sample rate.
    """
