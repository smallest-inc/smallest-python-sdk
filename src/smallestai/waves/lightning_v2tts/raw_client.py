...
class RawLightningV2TtsClient:
    ...
    def connect(
        ...
        """
        ws_url = self._client_wrapper.get_environment().waves_ws + "/waves/v1/lightning-v2/get_speech/stream"
...
class AsyncRawLightningV2TtsClient:
