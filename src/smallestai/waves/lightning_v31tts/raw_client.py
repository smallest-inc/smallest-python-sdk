...
class RawLightningV31TtsClient:
    ...
    def connect(
        ...
        **JavaScript / TypeScript** (using `ws`)
        ...
        """
        ws_url = self._client_wrapper.get_environment().waves_ws + "/waves/v1/lightning-v3.1/get_speech/stream"
...
class AsyncRawLightningV31TtsClient:
