...
class PhoneNumbersApi:
    ...
    def product_phone_numbers_get(
        ...
        _param = self._product_phone_numbers_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProductPhoneNumbersGet200Response",
    ...
    @validate_call
    def product_phone_numbers_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductPhoneNumbersGet200Response]:
        """Get acquired phone numbers
    ...
    @validate_call
    def product_phone_numbers_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _product_phone_numbers_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/product/phone-numbers',
