...
class CampaignsApi:
    ...
    def campaign_delete(
        ...
        _param = self._campaign_delete_serialize(
            id=id,
    ...
    @validate_call
    def campaign_delete_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the campaign")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def campaign_delete_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the campaign")],
        _request_timeout: Union[
            None,
    ...
    def _campaign_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def campaign_id_stop_post(
        ...
        _param = self._campaign_id_stop_post_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def campaign_id_stop_post_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the campaign")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def campaign_id_stop_post_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the campaign")],
        _request_timeout: Union[
            None,
    ...
    def _campaign_id_stop_post_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/campaign/{id}/stop',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def campaign_post(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[CampaignPost200ResponseInner]:
        """Create a campaign
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[CampaignPost200ResponseInner]",
            '400': "BadRequestErrorResponse",
            '401': "UnauthorizedErrorReponse",
            '500': "InternalServerErrorResponse",
        }
    ...
    def campaign_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CampaignPost200ResponseInner]]:
        """Create a campaign
