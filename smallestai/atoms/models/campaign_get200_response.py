...
class CampaignGet200Response(BaseModel):
    """
    CampaignGet200Response
    """ # noqa: E501
    status: Optional[StrictBool] = None
    data: Optional[List[CampaignGet200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CampaignGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
